...
class Header extends React.Component
{
    ...
    responseGoogle = (response) => {
        console.log(response);
        this.setState({userName : response.profileObj.name,isLogged:true,loginModalIsOpen:false})
     }
    ...
    render()
    {
        const { loginModalIsOpen,isLogged,userName,createModalIsOpen,loginWithCredit} = this.state;
        return(
            <div class="app_header">
                            <button class="headerE" onClick={this.handleHome}>IS!</button>
                            {isLogged ?  <div>
                                {/* <img src ={image} /> */}
                                        ...
                                        <div><span class="glyphicon glyphicon-remove" onClick={this.handleClose} style={{float:'right',margin:'2px'}}></span></div>
                                            <div>
                                              <span style={{fontSize:'15px',fontSize: '20px',textAlign: 'center',top: '10%',position: 'absolute',left: '22%'}}>Login using Social Accounts </span>
                                                ...
                                                />
                                                  <div style={{color:'grey',fontStyle:'normal',fontWeight:'bold',textAlign: 'center',marginTop:'-25px'}}>-----------------------OR------------------------</div>
